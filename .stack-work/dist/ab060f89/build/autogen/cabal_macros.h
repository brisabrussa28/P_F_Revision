...
/* package proyectoBase-0.1.0.0 */
#ifndef VERSION_proyectoBase
#define VERSION_proyectoBase "0.1.0.0"
#endif /* VERSION_proyectoBase */
#ifndef MIN_VERSION_proyectoBase
#define MIN_VERSION_proyectoBase(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_proyectoBase */
...
/* package pdeprelude-0.2.0.0 */
#ifndef VERSION_pdeprelude
#define VERSION_pdeprelude "0.2.0.0"
#endif /* VERSION_pdeprelude */
#ifndef MIN_VERSION_pdeprelude
#define MIN_VERSION_pdeprelude(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_pdeprelude */
...
#define CURRENT_PACKAGE_KEY "proyectoBase-0.1.0.0-79Jl9QgExMS3rlc7WXl4XD"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "proyectoBase-0.1.0.0-79Jl9QgExMS3rlc7WXl4XD"
